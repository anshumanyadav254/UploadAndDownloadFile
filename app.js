...
mongoose.connect('mongodb+srv://anshu:anshu@cluster0.17jj2.mongodb.net/demo?retryWrites=true&w=majority',{useNewUrlParser:true,useUnifiedTopology: true})
.then(()=>console.log('Database is connected')).catch(err=>console.log('error ocured',err));
